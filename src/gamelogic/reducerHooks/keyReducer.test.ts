import { Dispatch, KeyboardEvent as ReactKeyboardEvent } from "react";
import { IKeyAction, keyReducer } from "./keyReducer"
import { IShapeAction } from "./liveShape";
import { ITickAction } from "./tick";
